...
eq_or_diff($main->get_extrayeardata('companion1'), '2', 'Entry companion1 - names truncated to same as another entry in same year');
eq_or_diff($main->get_extrayeardata('companion2'), '1', 'Entry companion2 - names truncated to same as another entry in same year');
