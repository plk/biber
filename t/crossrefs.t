...
my $cr1 = q|    \entry{cr1}{inbook}{}
      ...
      \field{original}{default}{sortinit}{G}
      \field{original}{default}{labeltitle}{Great and Good Graphs}
      \field{original}{default}{booktitle}{Graphs of the Continent}
      \strng{crossref}{cr_m}
      \field{original}{default}{eprintclass}{SOMECLASS}
      \field{original}{default}{eprinttype}{SomEPrFiX}
      \field{original}{default}{origyear}{1955}
      \field{original}{default}{title}{Great and Good Graphs}
      \field{original}{default}{year}{1974}
    \endentry
|;
...
my $cr2 = q|    \entry{cr2}{inbook}{}
      ...
      \field{original}{default}{sortinit}{F}
      \field{original}{default}{labeltitle}{Fabulous Fourier Forms}
      \field{original}{default}{booktitle}{Graphs of the Continent}
      \strng{crossref}{cr_m}
      \field{original}{default}{origyear}{1943}
      \field{original}{default}{title}{Fabulous Fourier Forms}
      \field{original}{default}{year}{1974}
    \endentry
|;
...
my $cr_m = q|    \entry{cr_m}{book}{}
      ...
      \field{original}{default}{sortinit}{G}
      \field{original}{default}{labeltitle}{Graphs of the Continent}
      \field{original}{default}{title}{Graphs of the Continent}
      \field{original}{default}{year}{1974}
    \endentry
|;
...
my $cr3 = q|    \entry{cr3}{inbook}{}
      ...
      \field{original}{default}{labeltitle}{Arrangements of All Articles}
      \field{original}{default}{booktitle}{Beasts of the Burbling Burns}
      \strng{crossref}{crt}
      \field{original}{default}{eprinttype}{sometype}
      \field{original}{default}{origyear}{1934}
      \field{original}{default}{title}{Arrangements of All Articles}
...
my $crt = q|    \entry{crt}{book}{}
      ...
      \field{original}{default}{labeltitle}{Beasts of the Burbling Burns}
      \field{original}{default}{title}{Beasts of the Burbling Burns}
      \field{original}{default}{year}{1996}
    \endentry
|;
...
my $cr6 = q|    \entry{cr6}{inproceedings}{}
      ...
      \field{original}{default}{sortinit}{A}
      \field{original}{default}{labeltitle}{Title of inproceeding}
      \field{original}{default}{booktitle}{Manual booktitle}
      \field{original}{default}{eventday}{21}
      \field{original}{default}{eventendday}{24}
      \field{original}{default}{eventendmonth}{08}
      \field{original}{default}{eventendyear}{2009}
      \field{original}{default}{eventmonth}{08}
      \field{original}{default}{eventtitle}{Title of the event}
      \field{original}{default}{eventyear}{2009}
      \field{original}{default}{title}{Title of inproceeding}
      \field{original}{default}{venue}{Location of event}
      \field{original}{default}{year}{2009}
      \field{original}{default}{pages}{123\bibrangedash}
    \endentry
|;
...
my $cr7 = q|    \entry{cr7}{inbook}{}
      ...
      \name{original}{default}{bookauthor}{1}{}{%
      ...
      \strng{fullhash}{8ab39ee68c55046dc1f05d657fcefed9}
      \field{original}{default}{sortinit}{A}
      \field{original}{default}{labeltitle}{Title of Book bit}
      \field{original}{default}{booksubtitle}{Book Subtitle}
      \field{original}{default}{booktitle}{Book Title}
      \field{original}{default}{booktitleaddon}{Book Titleaddon}
      \field{original}{default}{title}{Title of Book bit}
      \field{original}{default}{year}{2010}
      \field{original}{default}{pages}{123\bibrangedash 126}
      \verb{verbb}
      \verb String
      \endverb
    \endentry
...
my $cr8 = q|    \entry{cr8}{incollection}{}
      ...
      \field{original}{default}{sortinit}{S}
      \field{original}{default}{labeltitle}{Title of Collection bit}
      \field{original}{default}{booktitle}{Book Title}
      \field{original}{default}{title}{Title of Collection bit}
      \field{original}{default}{year}{2010}
      \field{original}{default}{pages}{1\bibrangedash 12}
    \endentry
|;
...
my $xr1 = q|    \entry{xr1}{inbook}{}
      ...
      \field{original}{default}{sortinit}{Z}
      \field{original}{default}{labeltitle}{Moods Mildly Modified}
      \field{original}{default}{origyear}{1921}
      \field{original}{default}{title}{Moods Mildly Modified}
      \strng{xref}{xrm}
    \endentry
|;
...
my $xr2 = q|    \entry{xr2}{inbook}{}
      ...
      \field{original}{default}{sortinit}{I}
      \field{original}{default}{labeltitle}{Migraines Multiplying Madly}
      \field{original}{default}{origyear}{1926}
      \field{original}{default}{title}{Migraines Multiplying Madly}
      \strng{xref}{xrm}
    \endentry
|;
...
my $xrm = q|    \entry{xrm}{book}{}
      ...
      \field{original}{default}{sortinit}{C}
      \field{original}{default}{labeltitle}{Calligraphy, Calisthenics, Culture}
      \field{original}{default}{title}{Calligraphy, Calisthenics, Culture}
      \field{original}{default}{year}{1970}
    \endentry
|;
...
my $xr3 = q|    \entry{xr3}{inbook}{}
      ...
      \field{original}{default}{sortinit}{N}
      \field{original}{default}{labeltitle}{Russian Regalia Revisited}
      \field{original}{default}{origyear}{1923}
      \field{original}{default}{title}{Russian Regalia Revisited}
      \strng{xref}{xrt}
    \endentry
|;
...
my $xrt = q|    \entry{xrt}{book}{}
      ...
      \field{original}{default}{sortinit}{K}
      \field{original}{default}{labeltitle}{Kings, Cork and Calculation}
      \field{original}{default}{title}{Kings, Cork and Calculation}
      \field{original}{default}{year}{1977}
    \endentry
|;
...
my $cr4 = q|    \entry{cr4}{inbook}{}
      ...
      \field{original}{default}{sortinit}{M}
      \field{original}{default}{labeltitle}{Enterprising Entities}
      \field{original}{default}{booktitle}{Vanquished, Victor, Vandal}
      \field{original}{default}{origyear}{1911}
      \field{original}{default}{title}{Enterprising Entities}
      \field{original}{default}{year}{1945}
    \endentry
|;
...
my $xr4 = q|    \entry{xr4}{inbook}{}
      ...
      \field{original}{default}{sortinit}{M}
      \field{original}{default}{labeltitle}{Lumbering Lunatics}
      \field{original}{default}{origyear}{1933}
      \field{original}{default}{title}{Lumbering Lunatics}
    \endentry
|;
...
my $ccr1 = q|    \entry{ccr2}{book}{}
      ...
      \field{original}{default}{sortinit}{V}
      \field{original}{default}{labeltitle}{Misc etc.}
      \strng{crossref}{ccr1}
      \field{original}{default}{title}{Misc etc.}
      \field{original}{default}{year}{1923}
    \endentry
|;
...
my $ccr2 = q|    \entry{ccr3}{inbook}{}
      ...
      \field{original}{default}{labeltitle}{Perhaps, Perchance, Possibilities?}
      \field{original}{default}{booktitle}{Misc etc.}
      \strng{crossref}{ccr2}
      \field{original}{default}{title}{Perhaps, Perchance, Possibilities?}
      \field{original}{default}{year}{1911}
    \endentry
|;
...
my $ccr3 = q|    \entry{ccr4}{inbook}{}
      ...
      \field{original}{default}{sortinit}{S}
      \field{original}{default}{labeltitle}{Stuff Concerning Varia}
      \field{original}{default}{booktitle}{Misc etc.}
      \field{original}{default}{title}{Stuff Concerning Varia}
      \field{original}{default}{year}{1911}
    \endentry
|;
