...
\item If \textcolor{blue}{\texttt{map\_entry\_new}} is set, a new entry is
  created with the entry key given as the value 
  to \textcolor{blue}{\texttt{map\_entry\_new}} and the entry type given in
  the option \textcolor{blue}{\texttt{map\_entry\_newtype}}. This 
