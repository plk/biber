...
* TODO Multiscript
** TODO Documentation
*** TODO \DeclareDatamodelMultiscriptEntryfields and \ResetDatamodelMultiscriptEntryfields
*** TODO multiscriptforms constant
*** TODO 'langtags' special annotation name.
*** TODO msform/mslang biblatex global options. The options control which alternates are selected in various templates by biber and which alternates are selected by \cites/\print* in refcontexts.
*** TODO msform/mslang refcontext options to select the defaults for \printfield and cites etc. Don't need to be passed to biber via .bcf as the biber needs for mslang/msform are already addressed as they indirectly change the current refcontext templates which in turn changes data. These options are there to influence the biblatex side of things. Default to globals.
*** TODO biber mslang option and that this is checked after biblatex global/entry(LANGID) (for tool mode use)
** TODO biblatex
*** DONE Datamodel
...
*** TODO msform and mslang biblatex global options
*** TODO msform and mslang biblatex refcontext options (but not passed to biber), inherit from global
*** TODO around 4560 in biblatex.sty - add mslang name option and set some macro, expose to user
*** TODO output sortlocale/mslang in .bcf as BCP-47 if possible (polyglossia 1.47+)
*** TODO inheritance templates
*** TODO sorting templates
*** TODO labelalphatemplate
*** TODO labelnamespec/labeltitlespec
*** TODO labelnamesource/labeltitlesource (2 extra args)
*** TODO Xnamehash, Xbibnamehash (2 extra args)
** TODO biber
...
*** TODO labelnamespec/labeltitlespec
**** TODO form/lang in labelnamespec is not working - lots of errors
**** DONE .bcf schema
**** TODO XSL
*** DONE labelnamesource/labeltitlesource
*** TODO Xnamehash, Xbibnamehash need generalising for alternates (~2695 in Biber.pm) and in bbl/bblxml output. Then these macros need extra args in biblatex
*** TODO bbl output
...
*** TODO LOCALE_MAP
**** TODO Duplicate regions (de-DE, fr-FR) in LOCALE_MAP?
**** TODO Wait for polyglossia 1.47 release. However, can we switch completely to BCP47 for .bcf and .bbl if babel does not support BCP47?
*** TODO bblxml output
**** TODO labelnamesource/labeltitlesource need form/lang outputting and schema changing for bblxml
*** TODO inheritance templates
*** TODO sorting templates
*** TODO labelalphatemplate
** TODO basically audit all ->get_field()
