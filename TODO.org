...
* TODO stdmodel:glashow is returning 0 for uniquename option - how? - line 3447 in Biber.pm
* TODO Remove list meta <BDS> stuff - just pre-processing that doesn't depend on lists and afterwards, things that do, including .bbl string generation.
* TODO bcf schema and xsl

removed from _init in Config.pm
