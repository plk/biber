...
but the example below use uppercase in places for clarity. The general
structure is:
...
«conversation» and the \verb+NOTE+ field to «Auto-created this field». It
also turns a \verb+RECORD+ entrytype into a \verb+MUSIC+ entrytype.
\bigskip
...
\textcolor{red}{\texttt{target-value}} and it resolves to the data source
field name. Continuing the example:
