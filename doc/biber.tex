...
searched for using the following rule, in descending order of
priority:\\[2ex]
...
Bibliography database files are searched for using the same rules as
control files (see section \ref{loc:cf} above).
...
logfile will default to «\verb+biber.blg+». You can
override the logfile name by using the \verb+--logfile+ option:

\begin{verbatim}
  biber --logfile=lfname test
\end{verbatim}
