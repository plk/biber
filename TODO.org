...
* TODO Multiscript
** TODO Add new datamodel constant list of default forms (transliteration, transcription, original, translation)
** Parsing BCP-47 function
*** LangTags.pm provides parse, returns LangTag object
*** https://tools.ietf.org/html/bcp47
*** https://www.iana.org/assignments/language-subtag-registry/language-subtag-registry
** Parsing variant function
** Inheritance of incomplete variants from higher level (inherit from field variants to annotations)
** Special annotation syntax for variant information markers so that they can inherit
