...
* TODO Multiscript
** TODO Documentation
*** TODO Document \DeclareDatamodelMultiscriptEntryfields and \ResetDatamodelMultiscriptEntryfields
*** TODO multiscriptforms constant
*** TODO 'langtags' special annotation name
*** TODO msform/mslang biblatex options and scopes (global/entry only)
...
*** TODO Add msform/mslang options to biblatex as globals/per-refcontext, inherit mslang from doc lang
*** TODO bbl output
*** TODO Duplicate regions (de-DE, fr-FR) in LOCALE_MAP? - wait for package as per github.com/reutenauer/polyglossia/issues/226
*** TODO bblxml output
