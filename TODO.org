...
* TODO Multiscript
** Document \DeclareDatamodelMultiscriptEntryfields and \ResetDatamodelMultiscriptEntryfields
** TODO Add new datamodel constant list of default forms (transliteration, transcription, original, translation)
** DONE Parsing BCP-47 function
*** https://tools.ietf.org/html/bcp47
*** https://www.iana.org/assignments/language-subtag-registry/language-subtag-registry
** Parsing variant function
** annotation BCP47 tag parts override field tag parts
