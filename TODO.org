...
* TODO uniquenametemplate currently only looks at global only, make refsection/entry/name option
* TODO make labelalphanametemplatename into refsection/entry/name option
* TODO requires changes in all .bcfs and to \blx@refcontext@context (line 8219) in biblatex.sty, probably in bltx sortlist test doc 
