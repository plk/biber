...
** TODO 5.2.2 - expand to ranges in biber and put in X{end}dateuncertain{day,month,year,decade}
*** TODO biblatex unspec
*** TODO Don't forget bibtex legacy fallbacks for any tests
