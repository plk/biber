...
\DeclareSortTranslit[entrytype]{%
  \translit[field or fieldset]{from}{to}
}

package Lingua::Dev into biber as Biber::Translit.
document allowable from/to pairs
parse in Biber.pm, use in constructing sort key part for fields in Internals.pm
