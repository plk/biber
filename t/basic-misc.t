...
is_deeply( [ $biber->sortlists->get_list(0, 'shorthands', 'list', 'shorthands', 'global')->get_keys ], [ 'kant:kpv', 'kant:ku' ], 'shorthands' ) ;
...
$biber->prepare ;
$section = $biber->sections->get_section(0);
$main = $biber->sortlists->get_list(0, 'nty', 'entry', 'nty', 'global');
$out = $biber->get_output_obj;
