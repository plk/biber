...
eq_or_diff(NFC(latex_decode("{M{\\'a}t{\\'e}}")), '{Máté}', 'latex decode accent 1 (with explicit brace protection)');
...
eq_or_diff(NFC(latex_decode('{\"{U}}ber {\"{U}}berlegungen zur {\"{U}}berwindung des {\"{U}}bels')), 'Über Überlegungen zur Überwindung des Übels', 'latex decode 4 (with explicit brace protection)');
...
eq_or_diff(latex_decode('{C}apital'), 'Capital', 'latex decode 15');
