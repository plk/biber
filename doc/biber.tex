...
\opt{--output-resolve} option which will process any \bibfield{XDATA}
...
fields. The option \opt{tool-align} can be used to align all field
...
\opt{--tool-resolve} option, inheritance processing is performed on the
