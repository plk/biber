...
# perl was released
if [ -d "/usr/lib/perl5/vendor_perl/${perlv}/x86_64-cygwin-threads/Unicode/Collate" ]
then
  ucpath="/usr/lib/perl5/vendor_perl/${perlv}/x86_64-cygwin-threads/Unicode/Collate"
fi
...
PAR_VERBATIM=1 pp \
   ...
   --addfile="/usr/share/perl5/vendor_perl/${perlv}/Specio;lib/Specio" \
   --cachedeps=scancache \
