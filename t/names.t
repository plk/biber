...
eq_or_diff($section->bibentry('L27')->get_field('author', 'original', 'english')->count_names, 1, 'Bad name with 3 commas');
...
is($bibentries->entry('V1')->get_field($bibentries->entry('V1')->get_labelname_info, 'original', 'english')->count_names, '2', 'Name count for "and others" - 1');
is($bibentries->entry('V1')->get_field($bibentries->entry('V1')->get_labelname_info, 'original', 'english')->get_visible_cite, '2', 'Visibility for "and others" - 1');
is($bibentries->entry('V2')->get_field($bibentries->entry('V2')->get_labelname_info, 'original', 'english')->get_visible_cite, '1', 'Visibility for "and others" - 2');
...
is(NFC($bibentries->entry('L21')->get_field($bibentries->entry('L21')->get_labelname_info, 'original', 'english')->nth_name(1)->get_firstname_i->[0]), 'Š', 'Terseinitials 1'); # Should be in NFD UTF-8
