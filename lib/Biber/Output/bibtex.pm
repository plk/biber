...
sub output {
  ...
  foreach my $key ($Biber::MASTER->sortlists->get_list(99999, 'entry', Biber::Config->getblxoption('sortscheme'), map_locale(Biber::Config->getblxoption('sortlocale')))->get_keys) {
