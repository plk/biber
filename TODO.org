...
** TODO Documentation
*** TODO \msformloop{fieldname} \mslangloop{fieldname} (only in formats)
*** TODO Annotation macros + MS args
*** TODO NAMEnamehash, NAMEbibnamehash NAMEfullhas etc. are now NAMEFORMLANGnamehash and NAMEFORMLANGbibnamehash (also doc in changes as incompat change)
*** TODO Add general docs about citations to main MS doc section
...
*** TODO \blx@bbl@msformsdef and  \blx@bbl@mslangsdef are csvs of all forms/langs used for loading langs
*** DONE Save list of forms and langs per entry@field and make user macros
*** TODO multiscript fields/lists/names
**** TODO 7372 - blx@bbl@msdef@i uncommment and then all abx@field, abx@list and abx@name calls need examining
*** TODO Default global mslang to main document language BCP47 tag equivalent
