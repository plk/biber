...
Biber::Config->setblxoption('labelyearspec', [ {content => 'year', type => 'field'},
                                               {content => 'eventyear', type => 'field'},
                                               {content => 'origyear', type => 'field'} ]);
...
# reset options and regenerate information
Biber::Config->setblxoption('labelyearspec', [ {content => 'origyear', type => 'field'},
...
# reset options and regenerate information
Biber::Config->setblxoption('labelyearspec', [ {content => 'eventyear', type => 'field'},
                                               {content => 'year', type => 'field'},
                                               {content => 'origyear', type => 'field'} ], 'PER_TYPE', 'proceedings');
$bibentries->del_entry('L17');
$biber->prepare;
$out = $biber->get_output_obj;
