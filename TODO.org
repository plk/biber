...
*** TODO 'langtags' special annotation name means \namepart<part>mslang,\namepart<part>msform in name .bbl. This is a convenience as the same info will be in the annotations
...
*** TODO auto-create <namepart>msform, <namepart>mslang (top biblatex.def)
...
*** TODO labelalphanametemplate
*** TODO sortingnamekeytemplate
*** TODO uniquenametemplate
** TODO biber
...
*** TODO langtags annotations for names go into mslang, msform options in the name and .bbl (as well as annotions) (->nth_mslang)
*** TODO bbl output
*** TODO LOCALE_MAP
