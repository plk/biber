...
my $l1 = [ "Invalid format '1985-1030' of date field 'origdate' in entry 'L1' - ignoring",
           ...
           "Invalid value of field 'month' must be and integer between 1 and 12 - ignoring field in entry 'L1'" ];
...
my $l6 = [ "Invalid value '19961303' of date field 'date' - ignoring field in entry 'L6'" ];
my $l7 = [ "Invalid value '19961035' of date field 'eventdate' - ignoring field in entry 'L7'" ];
my $l8 = [ "Invalid value of field 'month' must be and integer between 1 and 12 - ignoring field in entry 'L8'" ];
