...
my $cr1 = q|    \entry{cr1}{inbook}{}
      ...
      \field{form=original,lang=default}{sortinit}{G}
      \field{form=original,lang=default}{labeltitle}{Great and Good Graphs}
      \field{form=original,lang=default}{booktitle}{Graphs of the Continent}
      \strng{crossref}{cr_m}
      \field{form=original,lang=default}{eprintclass}{SOMECLASS}
      \field{form=original,lang=default}{eprinttype}{SomEPrFiX}
      \field{form=original,lang=default}{origyear}{1955}
      \field{form=original,lang=default}{title}{Great and Good Graphs}
      \field{form=original,lang=default}{year}{1974}
    \endentry
|;
...
my $cr2 = q|    \entry{cr2}{inbook}{}
      ...
      \field{form=original,lang=default}{labeltitle}{Fabulous Fourier Forms}
      \field{form=original,lang=default}{booktitle}{Graphs of the Continent}
      \strng{crossref}{cr_m}
      \field{form=original,lang=default}{origyear}{1943}
...
my $cr_m = q|    \entry{cr_m}{book}{}
      ...
      \field{form=original,lang=default}{sortinit}{G}
      \field{form=original,lang=default}{labeltitle}{Graphs of the Continent}
...
my $cr3 = q|    \entry{cr3}{inbook}{}
      ...
      \field{form=original,lang=default}{labeltitle}{Arrangements of All Articles}
      \field{form=original,lang=default}{booktitle}{Beasts of the Burbling Burns}
      \strng{crossref}{crt}
      \field{form=original,lang=default}{eprinttype}{sometype}
      \field{form=original,lang=default}{origyear}{1934}
...
my $crt = q|    \entry{crt}{book}{}
      ...
      \field{form=original,lang=default}{labeltitle}{Beasts of the Burbling Burns}
...
my $cr6 = q|    \entry{cr6}{inproceedings}{}
      ...
      \field{form=original,lang=default}{sortinit}{A}
      \field{form=original,lang=default}{labeltitle}{Title of inproceeding}
      \field{form=original,lang=default}{booktitle}{Manual booktitle}
      \field{form=original,lang=default}{eventday}{21}
      \field{form=original,lang=default}{eventendday}{24}
      \field{form=original,lang=default}{eventendmonth}{08}
      \field{form=original,lang=default}{eventendyear}{2009}
      \field{form=original,lang=default}{eventmonth}{08}
      \field{form=original,lang=default}{eventtitle}{Title of the event}
      \field{form=original,lang=default}{eventyear}{2009}
      ...
      \field{form=original,lang=default}{pages}{123\bibrangedash}
    \endentry
|;
...
my $cr7 = q|    \entry{cr7}{inbook}{}
      ...
      \strng{fullhash}{8ab39ee68c55046dc1f05d657fcefed9}
      \field{form=original,lang=default}{sortinit}{A}
      \field{form=original,lang=default}{labeltitle}{Title of Book bit}
      ...
      \field{form=original,lang=default}{pages}{123\bibrangedash 126}
      \verb{verbb}
      \verb String
      \endverb
    \endentry
...
my $cr8 = q|    \entry{cr8}{incollection}{}
      ...
      \field{form=original,lang=default}{labeltitle}{Title of Collection bit}
      \field{form=original,lang=default}{booktitle}{Book Title}
      \field{form=original,lang=default}{title}{Title of Collection bit}
      \field{form=original,lang=default}{year}{2010}
      \field{form=original,lang=default}{pages}{1\bibrangedash 12}
    \endentry
|;
...
my $xr1 = q|    \entry{xr1}{inbook}{}
      ...
      \field{form=original,lang=default}{sortinit}{Z}
      \field{form=original,lang=default}{labeltitle}{Moods Mildly Modified}
      \field{form=original,lang=default}{origyear}{1921}
...
my $xr2 = q|    \entry{xr2}{inbook}{}
      ...
      \field{form=original,lang=default}{sortinit}{I}
      \field{form=original,lang=default}{labeltitle}{Migraines Multiplying Madly}
      \field{form=original,lang=default}{origyear}{1926}
...
my $xrm = q|    \entry{xrm}{book}{}
      ...
      \field{form=original,lang=default}{sortinit}{C}
      \field{form=original,lang=default}{labeltitle}{Calligraphy, Calisthenics, Culture}
      \field{form=original,lang=default}{title}{Calligraphy, Calisthenics, Culture}
      \field{form=original,lang=default}{year}{1970}
    \endentry
|;
...
my $xr3 = q|    \entry{xr3}{inbook}{}
      ...
      \field{form=original,lang=default}{sortinit}{N}
      \field{form=original,lang=default}{labeltitle}{Russian Regalia Revisited}
      \field{form=original,lang=default}{origyear}{1923}
...
my $xrt = q|    \entry{xrt}{book}{}
      ...
      \field{form=original,lang=default}{sortinit}{K}
      \field{form=original,lang=default}{labeltitle}{Kings, Cork and Calculation}
      \field{form=original,lang=default}{title}{Kings, Cork and Calculation}
      \field{form=original,lang=default}{year}{1977}
    \endentry
|;
...
my $cr4 = q|    \entry{cr4}{inbook}{}
      ...
      \field{form=original,lang=default}{labeltitle}{Enterprising Entities}
      \field{form=original,lang=default}{booktitle}{Vanquished, Victor, Vandal}
      \field{form=original,lang=default}{origyear}{1911}
      \field{form=original,lang=default}{title}{Enterprising Entities}
      \field{form=original,lang=default}{year}{1945}
    \endentry
|;
...
my $xr4 = q|    \entry{xr4}{inbook}{}
      ...
      \field{form=original,lang=default}{sortinit}{M}
      \field{form=original,lang=default}{labeltitle}{Lumbering Lunatics}
      \field{form=original,lang=default}{origyear}{1933}
...
my $ccr1 = q|    \entry{ccr2}{book}{}
      ...
      \field{form=original,lang=default}{sortinit}{V}
      \field{form=original,lang=default}{labeltitle}{Misc etc.}
      \strng{crossref}{ccr1}
      \field{form=original,lang=default}{title}{Misc etc.}
      \field{form=original,lang=default}{year}{1923}
    \endentry
|;
...
my $ccr2 = q|    \entry{ccr3}{inbook}{}
      ...
      \field{form=original,lang=default}{labeltitle}{Perhaps, Perchance, Possibilities?}
      ...
      \field{form=original,lang=default}{year}{1911}
    \endentry
|;
...
my $ccr3 = q|    \entry{ccr4}{inbook}{}
      ...
      \field{form=original,lang=default}{sortinit}{S}
      \field{form=original,lang=default}{labeltitle}{Stuff Concerning Varia}
      \field{form=original,lang=default}{booktitle}{Misc etc.}
