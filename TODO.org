...
*** TODO all changed macros ...
*** TODO \field in \DeclareLabelalphaTemplate to say that non-name list fields apply the template to each list member
*** TODO Inheritance is of all alternates
** TODO biblatex
*** DONE Datamodel
...
*** TODO NAMEnamehash, NAMEbibnamehash are now NAMEFORMLANGnamehash and NAMEFORMLANGbibnamehash
** TODO biber
