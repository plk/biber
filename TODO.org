...
** TODO Document
*** TODO Default position when omitted for list sources is 1
*** TODO granular xdata doesn't work for dates
*** TODO granular xdata at field level and below must be between same field and datatypes
