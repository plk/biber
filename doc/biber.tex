...
\gdef\biberversion{1.7}    % BIBER VERSION
\gdef\biblatexversion{2.7}   % BIBLATEX VERSION
...
\item User-definable mapping and suppression of fields and entrytypes in
  ...
  \bibfield{ABSTRACT} fields completely. See section \ref{map}
...
\biber in «tool» mode (see section\ref{tool}) when you need to specify the
