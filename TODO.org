...
* TODO sortcites changes
** TODO   <bcf:sortingnamekeytemplate visibility_type="cite">
** TODO create APA template, set as default, switch refcontext for \printbibliography to normal
** TODO Doc new \visibility option, bump .bcf version
** TODO doc \AtBeginRefsection, just after refsection number setting
* TODO Multiscript
** Documentation
...
*** TODO Parsing field alternates function
*** TODO annotation BCP47 tag parts override field tag part
