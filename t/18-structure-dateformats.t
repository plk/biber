...
is( $out->get_output_entry('l13'), $l13c, 'Date values test 13c - labelyear open-ended range' ) ;
is( $out->get_output_entry('l14'), $l14, 'Date values test 14 - labelyear same as YEAR when ENDYEAR == YEAR') ;
is( $out->get_output_entry('l15'), $l15, 'Date values test 15 - labelyear should be undef, no DATE or YEAR') ;
...
is($out->get_output_entry('l16'), $l16, 'Date values test 16a - labelyear = EVENTYEAR value when YEAR is (mistakenly) missing' );
is($bibentries->entry('l17')->get_field('labelyearname'), 'year', 'Date values test 17 - labelyearname = YEAR' ) ;
is($out->get_output_entry('l17'), $l17, 'Date values test 17a - labelyear = YEAR value when ENDYEAR is the same and ORIGYEAR is also present' ) ;
...
is($out->get_output_entry('l17'), $l17c, 'Date values test 17c - labelyear = ORIGYEAR value when ENDORIGYEAR is the same and YEAR is also present' ) ;
...
is($out->get_output_entry('l17'), $l17e, 'Date values test 17e - labelyear = ORIGYEAR-ORIGENDYEAR' ) ;
