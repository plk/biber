...
\gdef\biberversion{1.8}    % BIBER VERSION
\gdef\biblatexversion{2.8}   % BIBLATEX VERSION
...
\hspace*{2em}\biblatex per-sortlist locale option\\
...
\biblatex passes sortlist-specific sorting locales and its global sorting
...
as the \opt{locale} option to a \cmd{printbibliography} macro. For example,
