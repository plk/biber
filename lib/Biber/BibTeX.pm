...
sub _text_bibtex_parse {
    ...
    while ( my $entry = new Text::BibTeX::Entry $bib ) {
        ...
        # This takes care of skipping @comments such as those generated by BibDesk:
        unless ( $entry->key ) {
            warn "Cannot get the key of entry no $count : Skipping\n" ;
            next 
        }
        ...
        if ( $bibentries{ $key } ) {
					...
					print "Repeated entry---key $key in file $f\nI'm skipping whatever remains of this entry\n"
