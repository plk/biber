...
\item Change the \textcolor{red}{\texttt{source-field}} to
  ...
  \textcolor{red}{\texttt{source-field-lang}} can be used to select
  specific variants of a multiscript field. If neither are specified, all
  variants of \textcolor{red}{\texttt{source-field}} will be mapped to
  corresponding variants of \textcolor{red}{\texttt{target-field}}. If only
  \textcolor{red}{\texttt{source-field-form}} is specified, the mapping
  will select the variant of the field with the specified form, whatever
  the language of the field variant. If there is more than one field variant with
  the same \textcolor{red}{\texttt{source-field-form}} and different lang,
  the \textcolor{red}{\texttt{source-field}} will not be selected. If only
  \textcolor{red}{\texttt{source-field-lang}} is specified, the mapping
  will select the variant of the field with the specified lang, whatever
  the form of the field variant. If there is more than one field variant with
  the same \textcolor{red}{\texttt{source-field-lang}} and different form,
  the \textcolor{red}{\texttt{source-field}} will not be selected.
...
\bibfield{NOTE} fields with translated form and german language.
