...
values is customisable with the \biber option \verb+--xnamesep+. Here is an
example:
\begin{verbatim}
...
\end{verbatim}
%
Per-namelist and per-name options may be specific in the extended name
format:
\begin{verbatim}
AUTHOR = {namelistopt=true and Hans Harman and given=Simon, family=Beumont, nameopt=true}
\end{verbatim}
