...
Readonly::Hash my %FIELDS => (
  ...
  date     => { date => 1, eventdate => 1, origdate => 1, urldate => 1 },
  field    => [
  ...
  nullok   => { endyear => 1, eventendyear => 1, origendyear => 1, urlendyear => 1 },
  range    => { pages => 1 },
  skipout  => {
                date      => 1,
                entryset  => 1,
  ...
  verbatim => { doi => 1, eprint => 1, file => 1, pdf => 1, url => 1, verba => 1, verbb => 1, verbc => 1 }
);
