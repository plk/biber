...
* TODO dateera=simple should -1 all bce years on output
** TODO Remove yearabs from biber, biblatex needs to +1 all bce abs values on output when dateera is not "astronomical"
** TODO fix biber tests
* TODO Remove uniquework?
