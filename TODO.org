...
* TODO Make handlers return the value and set outside of handler to variant can be set without changing all handlers. Do this in dev branch as it's neater anyway.
