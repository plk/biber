...
is(NFC(latex_decode('Mu\d{h}ammad ibn M\=us\=a al-Khw\=arizm\={\i} \r{a}')), 'Muḥammad ibn Mūsā al-Khwārizmı̄ å', 'latex decode 1');
...
is(NFC(latex_decode("\\'\\i")), 'ı́', 'latex decode 5'); # checking i/j with accents
is(NFC(latex_decode("\\^{\\j}")), 'ȷ̂', 'latex decode 6'); # checking i/j with accents
is(NFC(latex_decode("\\u{\\i}")), 'ı̆', 'latex decode 7'); # checking i/j with accents
is(NFC(latex_decode("\\u\\i")), 'ı̆', 'latex decode 8'); # checking i/j with accents
is(latex_decode('\i'), 'ı', 'latex decode 9'); # checking dotless i
is(latex_decode('\j'), 'ȷ', 'latex decode 10'); # checking dotless j
is(latex_decode('\textdiv'), '÷', 'latex decode 11'); # checking multiple set for types
is(latex_decode('\textbackslash'), "\\", 'latex decode 12'); # checking multiple set for types
is(latex_decode('--'), '--', 'latex decode 13'); # Testing raw
...
is(latex_encode(NFD('Åå')), '\r{A}\r{a}', 'latex encode 9');
is(latex_encode(NFD('a̍')), '\|{a}', 'latex encode 10');
is(latex_encode(NFD('ı̆')), '\u{\i}', 'latex encode 11');
