...
is_deeply([$biber->sortlists->get_list(0, 'lname', 'entry', 'lname')->get_keys], ['K11', 'K1', 'K2', 'K4', 'K3', 'K7', 'K8', 'K9', 'K10', 'K5', 'K6'], 'List - name order');
is_deeply([$biber->sortlists->get_list(0, 'lyear', 'entry', 'lyear')->get_keys], ['K4', 'K1', 'K2', 'K3', 'K6', 'K5', 'K7', 'K8', 'K9', 'K10', 'K11'], 'List - year order');
is_deeply([$biber->sortlists->get_list(0, 'ltitle', 'entry', 'ltitle')->get_keys], ['K1', 'K7', 'K8', 'K9', 'K4', 'K10', 'K2', 'K6', 'K5', 'K3', 'K11'], 'List - title order');
is_deeply([$biber->sortlists->get_list(0, 'ltitlef', 'entry', 'ltitlef')->get_keys], ['K11', 'K1', 'K7', 'K8', 'K9', 'K4', 'K10', 'K2', 'K6', 'K5', 'K3'], 'List - title order with form');
...
is_deeply([$biber->sortlists->get_list(0, 'lnamef3', 'entry', 'lnamef3')->get_keys], ['K11', 'K1', 'K2', 'K7', 'K5', 'K6'], 'List - name order (filtered) - 3');
...
is_deeply([$biber->sortlists->get_list(0, 'lnameswe', 'entry', 'lnameswe')->get_keys], ['K11', 'K1', 'K2', 'K4', 'K3', 'K7', 'K8', 'K9', 'K10', 'K6', 'K5'], 'List - name order (swedish)');
