...
*** TODO Add new datamodel constant list of default forms (original, transliteration, transcription, translation)
** Biber
*** DONE Parsing BCP47 function
https://tools.ietf.org/html/bcp47

*** TODO Parsing variant function
*** TODO annotation BCP47 tag parts override field tag parts
