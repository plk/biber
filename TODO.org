...
* TODO Volume and ? to ints and remove padding?
* TODO Enforce year/month format as ints - sortyear should be int only and documented so. Enforce in biber (not datamodel as it's not part of that)
* TODO Tune ...
* DONE final sort elements copy string into all further fields which dies on int schema
* TODO Decomm RIS
* TODO Remove/convert fastsort?
