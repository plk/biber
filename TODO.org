...
*** TODO Add to general docs
**** TODO general citation/print*/if*
*** TODO Default global mslang to main document language BCP47 tag equivalent
...
*** TODO multiscript fields/lists/names
**** DONE 7442 - blx@bbl@msdef@i uncommment and then all abx@field, abx@list and abx@name calls need examining
**** DONE \printfield
**** DONE \printlist
**** DONE \printname
**** DONE \iffieldundef
...
**** TODO \blx@imc@clearfield (must provide both form/lang or neither)
**** TODO \blx@imc@clearlist (must provide both form/lang or neither)
**** TODO \blx@imc@clearname (must provide both form/lang or neither)
**** TODO \blx@imc@restorefield
**** TODO \blx@imc@restorelist
**** TODO \blx@imc@restorename
**** TODO \blx@imc@iffieldsequal
**** TODO \blx@imc@iflistssequal
**** TODO \blx@imc@ifnamesequal
**** TODO \blx@imc@iffieldequals
**** TODO \blx@imc@iflistequals
**** TODO \blx@imc@ifnameequals
**** TODO \blx@imc@iffieldequalcs
**** TODO \blx@imc@iflistequalcs
**** TODO \blx@imc@ifnameequalcs
**** TODO \blx@imc@iffieldequalstr
**** TODO \blx@iffieldxref
**** TODO \blx@iflistxref
**** TODO \blx@ifnamexref
**** TODO \citefield
**** TODO \citelist
**** TODO \citename
**** TODO \blx@imc@docsvfield
**** TODO \blx@imc@forcsvfiel
**** TODO \blx@imc@iffieldequals
**** TODO \blx@imc@iffieldequalstr
**** TODO \blx@imc@iffieldxref
**** TODO \blx@imc@iffieldint
**** TODO \blx@imc@iffieldnum
**** TODO \blx@imc@iffieldnums
**** TODO \blx@imc@iffieldpages
**** TODO \blx@imc@iffieldbibstring
**** TODO \blx@imc@iffieldplusstringbibstring
**** TODO \blx@imc@iflistequals
**** TODO \blx@imc@iflistxref
**** TODO \blx@imc@ifnameequals
**** TODO \blx@imc@ifnamexref
**** TODO \blx@savename
**** TODO \blx@savelist
**** TODO \blx@savefield
**** TODO blx@imc@savefield
**** TODO blx@imc@savelist
**** TODO blx@imc@savename
**** TODO blx@imc@savefieldcs
**** TODO blx@imc@savelistcs
**** TODO blx@imc@savenamecs
*** TODO Default global mslang to main document language BCP47 tag equivalent
