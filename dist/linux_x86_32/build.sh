...
# perl was released
if [ -d "/usr/local/perl/lib/site_perl/${perlv}/i686-linux/Unicode/Collate" ]
then
  ucpath="/usr/local/perl/lib/site_perl/${perlv}/i686-linux/Unicode/Collate"
fi
...
PAR_VERBATIM=1 /usr/local/perl/bin/pp \
  ...
  --addfile="/usr/local/perl/lib/${perlv}/i686-linux/PerlIO;lib/PerlIO" \
  --addfile="/usr/local/perl/lib/${perlv}/i686-linux/auto/PerlIO;lib/auto/PerlIO" \
